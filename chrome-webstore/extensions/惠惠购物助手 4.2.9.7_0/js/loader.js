            ...
            if (!on) {
                ...
                if(isAliCSP || isVipCSP){
                    ...
                    var now = new Date().getTime(),
                        ...
                        //线上
                        loadUrl = protocol == 'https:' ? "https://shared-https.ydstatic.com/gouwuex/ext/script/load_url_s.txt" : "http://shared.ydstatic.com/gouwuex/ext/script/load_url.txt";
