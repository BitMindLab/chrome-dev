...
window.i18n = function(t) {
    ...
    ini: function() {
        for (var t = $("[i18n]").length, n = 0; n < t; n++) {
            var e = $("[i18n]")[n],
                r = e.getAttribute("i18n"),
                i = i18n(r);
            $(e).text(i)
        }
        for (var o = $("[i18nh]").length, n = 0; n < o; n++) {
            var e = $("[i18nh]")[n],
                r = e.getAttribute("i18nh"),
                i = i18n(r);
            $(e).html(i)
        }
        for (var a = $("[i18n-placeholder]").length, n = 0; n < a; n++) {
            var e = $("[i18n-placeholder]")[n],
                r = e.getAttribute("i18n-placeholder"),
                i = i18n(r);
            $(e).attr("placeholder", i)
        }
        for (var l = $("[i18n-value]").length, n = 0; n < l; n++) {
            var e = $("[i18n-value]")[n],
                r = e.getAttribute("i18n-value"),
                i = i18n(r);
            $(e).attr("value", i)
        }
        for (var c = $("[i18n-title]").length, n = 0; n < c; n++) {
            var e = $("[i18n-title]")[n],
                r = e.getAttribute("i18n-title"),
                i = i18n(r);
            $(e).attr("title", i)
        }
    }
    ...
    var t = Math.floor(10 * Math.random()) + 1,
        n = $(".icobgColor:nth-child(" + t + ")").css("background-color");
    $(".icobgColor:nth-child(" + t + ")").css("border-color", n), $("#icon").css({
        "background-color": n
    }), $("#addTitle").live("input", function(t) {
        var n = $("#addTitle").val(),
            e = n.substring(0, 4);
        $("#icon").text(e)
        ...
        $(this).css("border-color", n), $("#icon").css({
            "background-color": n
        })
        ...
        chrome.tabs.query({
            ...
            for (var n = !0, e = 0; e < t.length; e++)
                if (console.log(t[e]), t[e].url.indexOf("chrome://newtab") >= 0) {
                    n = !1;
                    break
                }
